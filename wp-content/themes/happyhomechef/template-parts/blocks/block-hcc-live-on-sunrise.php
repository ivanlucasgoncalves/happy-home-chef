		...
		<div class="row align-items-center">
			<div class="col-lg-6 video-content">
				<div class="embed-responsive embed-responsive-16by9 border-radius">
					<iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/YPgmRMjaTDA?controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
