 ...
 * @return string
 */
function review_start_datetime($date, $time, $data)
{
    return apply_filters('tbk_frontend_review_start_date_time', $date . ' ' . $time, $date, $time, $data);
}
 ...
 * @return string
 */
function review_end_datetime($date, $time, $data)
{
    return apply_filters('tbk_frontend_review_end_date_time', $date . ' ' . $time, $date, $time, $data);
}
