...
class Admin
{
    ...
    private function saveCoworkerServiceSettings($email = FALSE, $apply_to_all = FALSE)
    {
        ...
        if (!$email) {
            ...
            if (strpos($linked_event_title_lowercase, apply_filters('tbk_google_summary_data_delimiter', '||')) !== FALSE
            ...
            if (isset($_POST['data']['booked_title'])) {
                if (strpos($_POST['data']['booked_title'], apply_filters('tbk_google_summary_data_delimiter', '||')) !== FALSE
    ...
    public function saveFrontendStyle()
    {
		...
		if (isset($_POST['tb-direct-page'])) {
            Functions\getSettings()->setLinksDirectPage(trim($_POST['tb-direct-page']));
        }
