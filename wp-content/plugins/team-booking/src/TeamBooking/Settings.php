...
class TeamBookingSettings
{
     ...
     * @return string
     */
    public function getLinksDirectPage()
    {
        if (get_post($this->links_direct_page)) {
            return $this->links_direct_page;
        }
     ...
     * @param string $id
     */
    public function setLinksDirectPage($id)
    {
        $this->links_direct_page = $id;
    }
