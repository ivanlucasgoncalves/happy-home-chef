            ...
            switch ($service->getSettingsFor('show_attendees')) {
                case 'name':
                    foreach ($customers as $customer) {
                        $return[ $customer['name'] . $customer['email'] . $customer['id'] ] = '<span class="tbk-attendee-name">'
                            . apply_filters('tbk_slot_customers_list_frontend_customer_name', $customer['name'], $customer)
                            . '</span>';
                    }
                    break;
                case 'email':
