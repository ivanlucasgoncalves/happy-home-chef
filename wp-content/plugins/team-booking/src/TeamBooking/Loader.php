...
class Loader
{
    public function load()
    {
        ...
        // add Stripe webhook listener
        add_action('wp_ajax_teambooking_stripe_webhook', 'teambooking_stripe_webhook');
        add_action('wp_ajax_nopriv_teambooking_stripe_webhook', 'teambooking_stripe_webhook');
    ...
    public static function find_shortcodes()
    {
		...
		$calendar_check = apply_filters('tbk_shortcode_found', $calendar_check, $post_content);
    ...
    public function register_shortcodes()
    {
        ...
        // Cancellation direct page
        add_shortcode('tb-cancellation', array(
            'TeamBooking\\Shortcodes\\Cancellation',
            'render',
        ));
    }
