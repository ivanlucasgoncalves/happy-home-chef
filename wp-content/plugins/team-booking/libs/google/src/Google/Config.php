...
class Google_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'TeamBooking\\Google\\Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'TeamBooking\\Google\\Google_Cache_File',
      'logger_class'  => 'TeamBooking\\Google\\Google_Logger_Null',
      ...
      'classes' => array(
        'TeamBooking\\Google\\Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'TeamBooking\\Google\\Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'TeamBooking\\Google\\Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'TeamBooking\\Google\\Google_Http_Request' => array(
        ...
        'TeamBooking\\Google\\Google_Auth_OAuth2' => array(
        ...
        'TeamBooking\\Google\\Google_Task_Runner' => array(
        ...
        'TeamBooking\\Google\\Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'TeamBooking\\Google\\Google_IO_Exception' => array(
        ...
        'TeamBooking\\Google\\Google_Cache_File' => array(
