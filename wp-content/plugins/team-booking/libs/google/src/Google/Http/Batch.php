...
class Google_Http_Batch
{
  ...
  private $batch_endpoint;
  
  public function __construct(Google_Client $client, $boundary = false, $batchEndpoint = '')
  {
    $this->client = $client;
    $this->base_path = $this->client->getBasePath();
	$this->batch_endpoint = $batchEndpoint;
  ...
  public function execute()
  {
    ...
    $url = $this->base_path . '/batch' . $this->batch_endpoint;
