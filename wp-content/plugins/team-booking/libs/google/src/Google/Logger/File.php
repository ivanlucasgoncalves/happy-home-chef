...
class Google_Logger_File extends Google_Logger_Abstract
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $file = $client->getClassConfig('TeamBooking\\Google\\Google_Logger_File', 'file');
    ...
    $mode = $client->getClassConfig('TeamBooking\\Google\\Google_Logger_File', 'mode');
    if (!$mode) {
      $this->mode = $mode;
    }

    $this->lock = (bool) $client->getClassConfig('TeamBooking\\Google\\Google_Logger_File', 'lock');
    $this->file = $file;
  }
