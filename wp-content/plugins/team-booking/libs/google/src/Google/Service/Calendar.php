...
class Google_Service_Calendar_Acl extends Google_Collection
{
  ...
  public $etag;
  protected $itemsType = 'TeamBooking\\Google\\Google_Service_Calendar_AclRule';
...
class Google_Service_Calendar_AclRule extends Google_Model
{
  ...
  public $kind;
  public $role;
  protected $scopeType = 'TeamBooking\\Google\\Google_Service_Calendar_AclRuleScope';
...
class Google_Service_Calendar_CalendarList extends Google_Collection
{
  ...
  public $etag;
  protected $itemsType = 'TeamBooking\\Google\\Google_Service_Calendar_CalendarListEntry';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Google_Service_Calendar_CalendarListEntry extends Google_Collection
{
  ...
  public $colorId;
  protected $defaultRemindersType = 'TeamBooking\\Google\\Google_Service_Calendar_EventReminder';
  ...
  public $kind;
  public $location;
  protected $notificationSettingsType = 'TeamBooking\\Google\\Google_Service_Calendar_CalendarListEntryNotificationSettings';
...
class Google_Service_Calendar_CalendarListEntryNotificationSettings extends Google_Collection
{
  ...
  protected $notificationsType = 'TeamBooking\\Google\\Google_Service_Calendar_CalendarNotification';
...
class Google_Service_Calendar_Colors extends Google_Model
{
  ...
  protected $calendarType = 'TeamBooking\\Google\\Google_Service_Calendar_ColorDefinition';
  protected $calendarDataType = 'map';
  protected $eventType = 'TeamBooking\\Google\\Google_Service_Calendar_ColorDefinition';
...
class Google_Service_Calendar_Event extends Google_Collection
{
  ...
  protected $attachmentsType = 'TeamBooking\\Google\\Google_Service_Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = 'TeamBooking\\Google\\Google_Service_Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = 'TeamBooking\\Google\\Google_Service_Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = 'TeamBooking\\Google\\Google_Service_Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = 'TeamBooking\\Google\\Google_Service_Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = 'TeamBooking\\Google\\Google_Service_Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = 'TeamBooking\\Google\\Google_Service_Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = 'TeamBooking\\Google\\Google_Service_Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = 'TeamBooking\\Google\\Google_Service_Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = 'TeamBooking\\Google\\Google_Service_Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = 'TeamBooking\\Google\\Google_Service_Calendar_EventDateTime';
...
class Google_Service_Calendar_EventReminders extends Google_Collection
{
  ...
  protected $overridesType = 'TeamBooking\\Google\\Google_Service_Calendar_EventReminder';
...
class Google_Service_Calendar_Events extends Google_Collection
{
  ...
  public $description;
  public $etag;
  protected $itemsType = 'TeamBooking\\Google\\Google_Service_Calendar_Event';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Google_Service_Calendar_FreeBusyCalendar extends Google_Collection
{
  ...
  protected $busyType = 'TeamBooking\\Google\\Google_Service_Calendar_TimePeriod';
  protected $busyDataType = 'array';
  protected $errorsType = 'TeamBooking\\Google\\Google_Service_Calendar_Error';
...
class Google_Service_Calendar_FreeBusyRequest extends Google_Collection
{
  ...
  protected $itemsType = 'TeamBooking\\Google\\Google_Service_Calendar_FreeBusyRequestItem';
  protected $itemsDataType = 'array';
  public $timeMax;
  public $timeMin;
  public $timeZone;
...
class Google_Service_Calendar_FreeBusyResponse extends Google_Model
{
  ...
  protected $calendarsType = 'TeamBooking\\Google\\Google_Service_Calendar_FreeBusyCalendar';
  protected $calendarsDataType = 'map';
  protected $groupsType = 'TeamBooking\\Google\\Google_Service_Calendar_FreeBusyGroup';
...
class Google_Service_Calendar_Settings extends Google_Collection
{
  ...
  public $etag;
  protected $itemsType = 'TeamBooking\\Google\\Google_Service_Calendar_Setting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
