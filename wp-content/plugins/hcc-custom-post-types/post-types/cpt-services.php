...
function cpt_services() {
	...
	$labels = array(
		'name'                  => _x( 'Services', 'Service', 'hcc-theme' ),
		'singular_name'         => _x( 'Service', 'Service', 'hcc-theme' ),
		'menu_name'             => __( 'Services', 'hcc-theme' ),
		'name_admin_bar'        => __( 'Service', 'hcc-theme' ),
		'archives'              => __( 'Item Archives', 'hcc-theme' ),
		'attributes'            => __( 'Item Attributes', 'hcc-theme' ),
		'parent_item_colon'     => __( 'Parent Item:', 'hcc-theme' ),
		'all_items'             => __( 'All Services', 'hcc-theme' ),
	...
	$args   = array(
		'label'               => __( 'Service', 'hcc-theme' ),
		'description'         => __( 'Services', 'hcc-theme' ),
		'labels'              => $labels,
