...
function cpt_reviews() {
	...
	$labels = array(
		'name'                  => _x( 'Reviews', 'Review', 'hcc-theme' ),
		'singular_name'         => _x( 'Review', 'Review', 'hcc-theme' ),
		'menu_name'             => __( 'Reviews', 'hcc-theme' ),
		'name_admin_bar'        => __( 'Review', 'hcc-theme' ),
		'archives'              => __( 'Item Archives', 'hcc-theme' ),
		'attributes'            => __( 'Item Attributes', 'hcc-theme' ),
		'parent_item_colon'     => __( 'Parent Item:', 'hcc-theme' ),
		'all_items'             => __( 'All Reviews', 'hcc-theme' ),
	...
	$args   = array(
		'label'               => __( 'Review', 'hcc-theme' ),
		'description'         => __( 'Reviews', 'hcc-theme' ),
		'labels'              => $labels,
