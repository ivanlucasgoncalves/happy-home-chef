        ...
        <?php endif; ?>
            ...
            <div class="cff-oembed-button">
                ...
                <div class="cff-oembed-promo cff-oembed-desc">
                    ...
                    <img src="<?php echo CFF_PLUGIN_URL .  'img/cff-oembed.png'; ?>" style="padding: 0px; background: white;">
                </div>
    ...
    <div id="cff-admin" class="wrap sw-landing-page">
        ...
        <div class="cff-sw-info">
            ...
            <a class="cff-sw-screenshot" href="https://smashballoon.com/social-wall/demo?utm_source=plugin-pro&utm_campaign=cff&utm_medium=sw-demo" target="_blank">
                ...
                <img src="<?php echo CFF_PLUGIN_URL .  'img/sw-screenshot.png'; ?>" alt="Smash Balloon Social Wall plugin screenshot showing Facebook, Instagram, Twitter, and YouTube posts combined into one wall.">
            </a>
        </div>
